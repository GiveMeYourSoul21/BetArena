...
function PokerGame() {
  ...
  useEffect(() => {
    ...
    }, 12000); // УВЕЛИЧЕНО: Интервал 5 секунды вместо 2
  ...
  return (
    <div className="relative w-full h-screen bg-gray-900 overflow-hidden flex items-center justify-center">
      ...
      {gameData?.status === 'playing' && (
        <div className="absolute bottom-32 right-6 xl:bottom-40 xl:right-20 2xl:bottom-32 2xl:right-32 flex flex-col items-end gap-3 z-40">
